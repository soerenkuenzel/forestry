...
rcpp_cppDataFrameInterface <- function(x, y, catCols, splitCols, linCols, numRows, numColumns) {
    .Call(`_forestry_rcpp_cppDataFrameInterface`, x, y, catCols, splitCols, linCols, numRows, numColumns)
}
...
rcpp_cppPredictInterface <- function(forest, x, aggregation, localVariableImportance, power = -1, trainVec = as.numeric( c()), testVec = as.numeric( c()), isCatDimension = FALSE) {
    .Call(`_forestry_rcpp_cppPredictInterface`, forest, x, aggregation, localVariableImportance, power, trainVec, testVec, isCatDimension)
}
...
rcpp_reconstructree <- function(x, y, catCols, splitCols, linCols, numRows, numColumns, R_forest, replace, sampsize, splitratio, mtry, nodesizeSpl, nodesizeAvg, nodesizeStrictSpl, nodesizeStrictAvg, minSplitGain, maxDepth, seed, nthread, verbose, middleSplit, maxObs, ridgeRF, overfitPenalty, doubleTree) {
    .Call(`_forestry_rcpp_reconstructree`, x, y, catCols, splitCols, linCols, numRows, numColumns, R_forest, replace, sampsize, splitratio, mtry, nodesizeSpl, nodesizeAvg, nodesizeStrictSpl, nodesizeStrictAvg, minSplitGain, maxDepth, seed, nthread, verbose, middleSplit, maxObs, ridgeRF, overfitPenalty, doubleTree)
}
