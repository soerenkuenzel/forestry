...
rcpp_cppPredictInterface <- function(forest, x, aggregation, localVariableImportance, featureName = "", power = -1) {
    .Call(`_forestry_rcpp_cppPredictInterface`, forest, x, aggregation, localVariableImportance, featureName, power)
}
