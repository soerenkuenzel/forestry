...
rcpp_cppPredictInterface <- function(forest, x, aggregation, localVariableImportance, power = -1, distanceNumCol = -1L) {
    .Call(`_forestry_rcpp_cppPredictInterface`, forest, x, aggregation, localVariableImportance, power, distanceNumCol)
}
