...
rcpp_cppDataFrameInterface <- function(x, y, catCols, linCols, numRows, numColumns, sampleWeights) {
    .Call(`_forestry_rcpp_cppDataFrameInterface`, x, y, catCols, linCols, numRows, numColumns, sampleWeights)
}
...
rcpp_reconstructree <- function(x, y, catCols, linCols, numRows, numColumns, R_forest, replace, sampsize, splitratio, mtry, nodesizeSpl, nodesizeAvg, nodesizeStrictSpl, nodesizeStrictAvg, minSplitGain, maxDepth, seed, nthread, verbose, middleSplit, maxObs, sampleWeights, ridgeRF, overfitPenalty, doubleTree) {
    .Call(`_forestry_rcpp_reconstructree`, x, y, catCols, linCols, numRows, numColumns, R_forest, replace, sampsize, splitratio, mtry, nodesizeSpl, nodesizeAvg, nodesizeStrictSpl, nodesizeStrictAvg, minSplitGain, maxDepth, seed, nthread, verbose, middleSplit, maxObs, sampleWeights, ridgeRF, overfitPenalty, doubleTree)
}
