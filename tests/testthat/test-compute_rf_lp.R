test_that("Tests that compute the lp distances works correctly", {
  ...
  distances_1 <- compute_lp(object = rf,
                            ...
                            feature = 4,
                            p = 1)
  expect_equal(distances_1, rep(1,11), tolerance = 1e-2)
  ...
  expect_equal(distances_2, c(2.628971, 2.360160, 2.177702, 2.574676, 2.404899,
                              2.212701, 2.091241, 2.622013, 2.276196, 2.465682,
                              2.801573),
               tolerance = 1e-2)
})
